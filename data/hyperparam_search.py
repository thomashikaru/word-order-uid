...
def train(cfg: DictConfig, trainer: Trainer, task: tasks.FairseqTask, epoch_itr):
...
def should_stop_early(cfg: DictConfig, valid_loss: float):
...
def get_training_stats(stats: Dict[str, Any]):
...
def get_valid_stats(cfg: DictConfig, trainer: Trainer, stats: Dict[str, Any]):
...
if __name__ == "__main__":
    ...
    analysis = tune.run(
        ...
        config={
            ...
            "decoder_ffn_embed_dim": tune.choice(1024, 2048, 3072),
            "decoder_layers": tune.choice(4, 6, 8),
            "dropout": tune.choice(0.1, 0.05, 0.2),
            "decoder_attention_heads": tune.choice(6, 8, 10),
        },
    )
