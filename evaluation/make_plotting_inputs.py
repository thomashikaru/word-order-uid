...
def main(args):
    ...
    surprisals.to_csv(f"{args.data_dir}/surprisal_plot_vals.csv", index=False)
    ...
    surprisal_variances.to_csv(
        f"{args.data_dir}/surprisal_variance_plot_vals.csv", index=False
    )
    ...
    df["surp_diff_squared"] = (
        df.surprisal - df.groupby(["language", "variant"]).surprisal.transform("mean")
    ) ** 2
    ...
    surprisal_deviations.to_csv(
        f"{args.data_dir}/surprisal_deviations_plot_vals.csv", index=False
    )
    ...
    delta_surps.to_csv(f"{args.data_dir}/delta_surps_plot_vals.csv", index=False)
    ...
    infs_1_1.to_csv(f"{args.data_dir}/infs_1.1_plot_vals.csv", index=False)
    ...
    infs.to_csv(f"{args.data_dir}/infs_plot_vals.csv", index=False)
    ...
    avg_surps.to_csv(f"{args.data_dir}/avg_surps_plot_vals.csv", index=False)
    ...
    max_surps.to_csv(f"{args.data_dir}/max_surps_plot_vals.csv", index=False)
